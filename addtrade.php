...
<nav class="navbar navbar-expand-lg bg-body-tertiary" data-bs-theme="dark">
    <div class="container-fluid" style="height: 25px">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="addtrade.php" style="padding-left:0px; padding-right:0px; width:160px; padding-top:12px">Inserir nova operação</a>
            </li>
            ...
            <li class="nav-item" style="margin-left: 750px">
                <a class="nav-link" href="operationspanel.php" style=" width:160px; padding-top:12px; font-weight: bold">Logout</a>
            </li>
        </ul>
        </div>
    </div>
    ...
    <div class='container' id='container' style='margin-top: 20px;'>
        ...
        <form style="margin-top: 35px" action="inserttrade.php" method="post">
            ...
            <div style="text-align:right">
                <button class="btn btn-outline-light" type="submit" style="margin-top: 10px">Inserir operação</button>
            </div>
