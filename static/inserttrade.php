				...
				<div class='container' id='container' style='width:400px'>
					...
					<form style="margin-top: 35px" action="dbtrade.php" method="post">
						<div class="input-group mb-3">
							...
							<select class="form-select" name ="ativo" id="inputGroupSelect01" required>
						...
						<div class="input-group mb-3">
							...
							<input type="date" name="data" class="form-control" aria-label="date" aria-describedby="addon-wrapping" required>
							</div>
						</div>

						<div class="input-group mb-3">
							<label class="input-group-text" for="inputGroupSelect01">Ponta</label>
							<select class="form-select" name="ponta" id="inputGroupSelect01" required>
						...
						<div class="input-group mb-3">
							...
							<select class="form-select" name="resultado" id="inputGroupSelect01" required>
								<option selected>Escolha...</option>
						...
						<div class="input-group mb-3">
							...
							<input type="number" name="pontos" class="form-control" placeholder="Se loss, insira negativo..." aria-label="Number" aria-describedby="addon-wrapping" required>
						</div>

						<div class="input-group mb-3">
							<span class="input-group-text">Resultado</span>
							<input type="number" name="resultadoValor" step="0.01" min="0.01" placeholder="Se loss, insira negativo..." class="form-control" aria-label="Amount (to the nearest dollar)" required>
